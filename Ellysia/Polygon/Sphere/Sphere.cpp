...
void Sphere::Initialize(DirectXInitialization* directXSetup) {
	...
	//頂点を6に増やす
	vertexResourceSphere_ = CreateBufferResource(sizeof(VertexData) * 6);
...
//描画
//左上、右上、左下、右下
void Sphere::Draw(Vector4 leftTop, Vector4 RightTop, Vector4 LeftBottom, Vector4 RightBottom, Transform transform, Vector4 color) {
