...
private:
	...
	static const int32_t PARTICLE_AMOUNT_ = 10;


	//Sprite用のTransformationMatrix用のリソースを作る。
	//Matrix4x4 1つ分サイズを用意する
	ComPtr<ID3D12Resource> transformationMatrixResource_[PARTICLE_AMOUNT_] = { nullptr };
	...
	//Lighting用
	ComPtr<ID3D12Resource> directionalLightResource_[PARTICLE_AMOUNT_] = { nullptr };
...
private:
	...
	std::random_device rnd_[3];
	float randPosition_[3] = { 0.0f };
	Transform transform_[PARTICLE_AMOUNT_] = {};
